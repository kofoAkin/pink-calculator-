...
from PyQt5.QtWidgets import QWidget, QApplication, QLabel, QGridLayout, QHBoxLayout, QVBoxLayout, QPushButton, QLineEdit
...
if __name__ in "__main__":
    app = QApplication([])
    main_window = CalcApp()
    main_window.setStyleSheet("QWidget {background-color: #FFC0CB}")
    main_window.show()
    app.exec_()                   
